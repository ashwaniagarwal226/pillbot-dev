/**
 * Author : Shweta K Chilaka
 * Date : April 04, 2012 at 11.00 AM
 * Purpose : javascript source file for implementing pagination in reports
 */
...
this.showPage = function (pageNumber) {
    ...
    var from = ((pageNumber - 1) * itemsPerPage + 1)+1;
